...
const FashionBanner = () => {
  return (
    <section className="relative w-full min-h-screen bg-[#eae4dd] overflow-hidden">
      ...
      <div className="container max-w-7xl mx-auto px-6 py-20 relative z-10 grid grid-cols-1 md:grid-cols-12 items-center gap-12">
        ...
        <div className="col-span-12 md:col-span-7 text-center md:text-left flex flex-col items-center md:items-start pl-0">
          <motion.h1
